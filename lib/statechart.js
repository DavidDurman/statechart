/**
 * Inspired by the Quantum hierarchical state machines by Miro Samek and its
 * implementation in Squeak Smalltalk Connectors package by Ned Konz.
 *
 * @file statechart.js
 * @author David Durman, 2010
 *
 * Copyright (c) David Durman 2010
...
var debug  = function(msg){
    if (!exports.NDEBUG) console.log(msg);
};
 ...
 */
var Statechart = exports.Statechart = {
    run: function(){
    ...
    handleUnhandledEvent: function(anEvent){
        debug("Unhandled event: " + anEvent.type);
	return null;
    },
    /**
...
QState.prototype = {
    ...
    enter: function(){
        debug("[" + this.name + "] enter");
	return this.trigger(QEventEntry);
    },
    exit: function(){
        debug("[" + this.name + "] exit");
...
var QEventEntry = new QEvent("entry"),
    QEventExit = new QEvent("exit"),
    QEventInit = new QEvent("init"),
    QEventEmpty = new QEvent("empty");

})(typeof exports !== "undefined" ? exports : Statechart = {});
